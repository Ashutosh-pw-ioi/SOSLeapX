...
const Services = () => {
  ...
  return (
    <>
      ...
      <section className="bg-[#FFF5D8] px-4 py-1 md:py-1 lg:py-1 mb-7">
        <div className="max-w-4xl mx-auto border border-[#E68C32]/60 rounded-xl shadow-md p-4 md:p-10 text-center bg-white/70 backdrop-blur-md">
          <h1 className="text-3xl md:text-3xl font-bold text-[#E68C38] mb-4 leading-snug drop-shadow">
            What is our Ask?
          </h1>
          <h2 className="text-lg md:text-2xl font-semibold text-gray-800 leading-relaxed tracking-wide">
            <span className="text-black">NO Equity.</span> <span className="text-black">NO Filters.</span>{' '}Just your
